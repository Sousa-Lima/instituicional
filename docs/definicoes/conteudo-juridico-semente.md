# Conteúdo e jurídico — ponto de partida

## Base editorial (não jurídica)

Os **perfis** descritos em [referencia-layout-sites.md](../conhecimento/referencia-layout-sites.md) (tabela *Referências*: Sagitta Digital e Venturus) servem como **inspiração inicial** de tom, seções e tipo de informação (serviços em blocos, FAQ, credibilidade, cases, etc.).
...
Ver [compliance-ferramentas.md](compliance-ferramentas.md).
